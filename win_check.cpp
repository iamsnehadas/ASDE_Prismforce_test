...
bool check(int no_of_boons, int no_of_recharges, int initial_power, ll enemy_power[]) {
    ...
    for(int i = 0; i < 11; i++) {
        if(current_power < enemy_power[i]) {
            /*He checks if he can recharge himself*/ /*If yes, he recharges, i.e., goes back to his initial power.*/
            if(recharges_used < no_of_recharges) {
                current_power = initial_power;
                 recharges_used++;
            }
            /*If he cannot recharge himself, he checks if he can use a boon*/
